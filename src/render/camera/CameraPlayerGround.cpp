...
CameraPlayerGround::CameraPlayerGround(Planet* p, Camera& c, PlanetFace& pf):
	...
	face(pf)
{
	localPosition=dspaceToBlock(glm::transpose(glm::dmat3(planet->getModel()))*c.getPositionDouble(glm::dvec3(planet->getPosition())),glm::dvec3(face.getOrigin()),glm::dvec3(face.getV1()),glm::dvec3(face.getV2()),glm::dvec3(face.getN()),planet->getNumBlocks());
...
void CameraPlayerGround::update(Camera& camera)
{
	...
	// 	glm::dvec3 uPos=dblockToSpace(localPosition,glm::dvec3(face.getOrigin()),glm::dvec3(face.getV1()),glm::dvec3(face.getV2()),planet->getNumBlocks());
